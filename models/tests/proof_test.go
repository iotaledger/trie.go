...
func TestTrieProofBlake2bStatic(t *testing.T) {
...
func TestTrieProofWithDeletesBlake2b32Static(t *testing.T) {
	var tr1 *trie.Trie
...
func TestTrieProofWithDeletesBlake2b20Static(t *testing.T) {
	var tr1 *trie.Trie
	var rootC trie.VCommitment
