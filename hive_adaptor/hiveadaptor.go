...
func NewHiveBatchedUpdater(kvs kvstore.KVStore, model common.CommitmentModel, triePrefix, valueStorePrefix []byte) (*HiveBatchedUpdater, error) {
	ret := &HiveBatchedUpdater{
		kvs: kvs,
		trie: mutable.NewTrie(
			model,
